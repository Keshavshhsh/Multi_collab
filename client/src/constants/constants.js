...
export const navigation = [
  ...
  export const features = [
    ...
    },
    {
      ...
      title: "WhiteBoard",
      path: "/whiteboard",
      text: "Collaborate on Ideas Visually! Create, sketch, and brainstorm together in real-time on an infinite canvas.",
      backgroundUrl: "./src/assets/feature/card-2.svg",
      imageUrl: "./src/assets/feature/whiteboard.webp",
    },
    {
      id: "6",
      title: "Text Editor",
      path: "/editor",
      text: "Rich Text Editing Made Easy! Write, format, and collaborate on documents with real-time synchronization.",
      backgroundUrl: "./src/assets/feature/card-3.svg",
      imageUrl: "./src/assets/feature/text-editor.webp",
      light: true,
    },
    {
      id: "7",
