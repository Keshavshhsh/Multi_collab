              ...
              >
                <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem]">
                  ...
                  <div className="flex items-center mt-auto">
                    <button 
                      onClick={() => navigate(item.path)}
                      className="ml-auto px-4 py-2 font-code text-xs font-bold text-n-1 uppercase tracking-wider bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 rounded-lg transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/50"
                    >
                      Explore more →
                    </button>
                  </div>
